              ...
              <nav className="flex flex-col space-y-3">
                ...
                {isAuthenticated ? (
                  ...
                  <div className="pt-3 border-t border-gray-200 space-y-2">
                    ...
                    <button
                      onClick={() => handleAuthClick('signup')}
                      className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 w-full"
                    >
                      Sign Up
                    </button>
                  </div>
